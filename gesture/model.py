...
images = []
data_dir = '/home/mini/Documents/hand_re/hand_gesture_mini/hand_gestures/thumb_down'
file_names = os.listdir(data_dir)
file_names = [file_name for file_name in file_names if not file_name.startswith ('.')] #.DS_Store 제외
for file_name in file_names:
    file_path = '{}/{}'.format(data_dir, file_name)
...
images = []
data_dir = '/home/mini/Documents/hand_re/hand_gesture_mini/hand_gestures/stop_sign'
file_names = os.listdir(data_dir)
file_names = [file_name for file_name in file_names if not file_name.startswith ('.')] #.DS_Store 제외
for file_name in file_names:
    file_path = '{}/{}'.format(data_dir, file_name)
...
=================================================================
input_1 (InputLayer)         [(None, None, 224, 224, 3 0         
_________________________________________________________________
my_layer (MyLayer)           (None, 400)               0         
_________________________________________________________________
